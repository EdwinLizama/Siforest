...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('formulario.store') }}" method="POST">
            ...
            <fieldset class="border p-2 mb-3 border-green">
                <legend class="w-auto legend-green">D. Justificación del aprovechamiento (marcar solamente una opción):</legend>
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="justificacion1" name="justificacion" value="planes_aprovechamiento">
                            <label class="form-check-label" for="justificacion1">
                                Formulación de planes de aprovechamiento en carbonales a productores de escasos recursos económicos menores o iguales a 7.0 hectáreas (Art. 4 c) y Art. 8 LF y Art. 4 RLF
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="justificacion2" name="justificacion" value="mantenimiento_raleo">
                            <label class="form-check-label" for="justificacion2">
                                Mantenimiento, raleo o aprovechamiento final de plantación forestal Art. 16
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="justificacion3" name="justificacion" value="aprovechamiento_sistemas_agroforestales">
                    ...
                    <div class="form-group col-md-4">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="justificacion4" name="justificacion" value="proteccion_saneamiento">
                            <label class="form-check-label" for="justificacion4">
                                Protección y saneamiento del bosque natural. Art. 10
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="justificacion5" name="justificacion" value="aprovechamiento_cafetales">
                            <label class="form-check-label" for="justificacion5">
                                Aprovechamiento de árboles en cafetal. Art. 17 a
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="justificacion6" name="justificacion" value="peligro_dano">
                    ...
                    <div class="form-group col-md-4">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="justificacion7" name="justificacion" value="arboles_danados">
                            <label class="form-check-label" for="justificacion7">
                                Árboles dañados o derribados por causas naturales. Art. 11
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="justificacion8" name="justificacion" value="frutales_cultivos_permanentes">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="justificacion9" name="justificacion" value="aprovechamiento_areas_bosque">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="justificacion10" name="justificacion" value="aprovechamiento_fuera_bosques">
                            <label class="form-check-label" for="justificacion10">
                                Aprovechamiento de árboles aislados con capacidad de rebrote Art. 17 b y c (Fuera de los bosques naturales)
                            </label>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function() {
            ...
            $('#departamento_solicitante').on('change', function() {
                ...
                if (departamento === 'Ahuachapán') {
                    ...
                    municipios = ['Antiguo Cuscatlán', 'Chiltiupán', 'Ciudad Arce', 'Colón', 'Comasagua', 'Huizúcar', 'Jayaque', 'Jicalapa', 'La Libertad', 'Nueva San Salvador', 'San Juan Opico', 'Quezaltepeque', 'Sacacoyo', 'San José Villanueva', 'San Matías', 'San Pablo Tacachico', 'Talnique', 'Tamanique', 'Teotepeque', 'Tepecoyo', 'Zaragoza'];
                } else if (departamento === 'La Paz') {
                    municipios = ['Cuyultitán', 'El Rosario', 'Jerusalén', 'Mercedes La Ceiba', 'Olocuilta', 'Paraíso de Osorio', 'San Antonio Masahuat', 'San Emigdio', 'San Francisco Chinameca', 'San Pedro Masahuat', 'San Juan Nonualco', 'San Juan Talpa', 'San Juan Tepezontes', 'San Luis La Herradura', 'San Luis Talpa', 'San Miguel Tepezontes', 'San Pedro Nonualco', 'San Rafael Obrajuelo', 'Santa María Ostuma', 'Santiago Nonualco', 'Tapalhuaca', 'Zacatecoluca'];
                    ...
                    municipios = ['Aguilares', 'Apopa', 'Ayutuxtepeque', 'Cuscatancingo', 'Delgado', 'El Paisnal', 'Guazapa', 'Ilopango', 'Mejicanos', 'Nejapa', 'Panchimalco', 'Rosario de Mora', 'San Marcos', 'San Martín', 'San Salvador', 'Santiago Texacuangos', 'Santo Tomás', 'Soyapango', 'Tonacatepeque'];
